...
### EDA 
  - Performed EDA using Jupyter notebook to get stats about the sample dataset like column datatypes, dsutribution of values in each column and identifying null values
...
### Data Cleaning and Transformation
  ...
  - The dataframe has more than 200MB data and is saved in Cloud Storage as a persistent layer using Python's gcsfs library
